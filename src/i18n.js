export const translations = {
  "es": {
    ...
    "hero": {
      ...
      "techBadge": "Soluciones digitales",
      "archBadge": "Diseño y arquitectura",
    ...
    "archCatalog": {
      "barberia": [
        "Barbería",
        "Diseño comercial",
        "Diseño de estación, iluminación, espejos, recepción y recorrido visual para atención premium."
      ],
      "estilismo": [
        "Estilismo",
        "Belleza profesional",
        "Ambientes elegantes para salón, atención al cliente, marca visual y circulación cómoda."
      ],
      "lash": [
        "Lash",
        "Studio visual",
        "Espacios limpios y fotogénicos para pestañas, cejas y servicios de belleza especializada."
      ],
      "manicure": [
        "Manicure / Pedicure",
        "Detalle y comodidad",
        "Zona de atención cómoda, ordenada y visualmente atractiva para servicios de uñas y pedicure."
      ],
      "spa": [
        "Spa",
        "Bienestar",
        "Atmósferas sensoriales, cálidas y relajantes para masajes, descanso y experiencia premium."
      ],
      "terraza": [
        "Terraza",
        "Exterior premium",
        "Espacios exteriores con iluminación, circulación, estilo y zonas de encuentro."
      ],
      "departamento": [
        "Departamento",
        "Recorridos 3D",
        "Videos de primer y segundo piso para mostrar distribución, acabados y experiencia de recorrido."
      ],
      "ejecucion": [
        "Ejecución",
        "Obra terminada",
        "Evidencias reales de ejecución, acabados e implementación de cocinas, dormitorios y salas."
      ]
    },
    "techCatalog": {
      "redes": [
    ...
    "archGesture": {
      ...
      "scrollDown": "Bajando por la página",
      "scrollUp": "Subiendo por la página",
      "scrollDownGesture": "BAJAR",
      "scrollUpGesture": "SUBIR",
      "scrollUpShort": "SUBIR",
    ...
    "gestureExperience": {
      ...
      "bootSensor": "INICIALIZANDO SENSOR",
      "bootModel": "CARGANDO MODELO DE MANO",
      "bootTracking": "BUSCANDO TU MANO",
      "bootReady": "TRACKING LISTO",
      "globalUnlock": "CONTROL GESTUAL DESBLOQUEADO",
      ...
      "tutorialTitle": "APRENDE EN 3 PASOS",
      "tutorialSteps": ["Muestra tu mano", "Apunta a una tarjeta", "Haz pinza para seleccionar"],
      "tutorialHand": "PASO 1 · Muéstrame una mano",
      "tutorialAim": "PASO 2 · Ahora apunta a una tarjeta",
      "tutorialPinch": "OBJETIVO FIJADO · Haz pinza",
      "tutorialComplete": "Perfecto · ya sabes controlar JYM",
      "tutorialReady": "Listo. Ahora puedes activar el control de la web completa.",
      "globalEnable": "Controlar JYM",
      "globalActive": "MODO GESTOS ACTIVO",
      "globalHelp": "Índice: apuntar · Pinza: seleccionar · Mano abierta: navegar · Puño: cancelar",
      "globalExit": "Salir",
      "globalEnabledToast": "Modo global activado · ahora controla JYM con tu mano",
      "globalAimToast": "Apunta a un control iluminado antes de hacer pinza",
      ...
      "selectionConfirmed": "ACCIÓN CONFIRMADA",
      "feedbackIdle": "ESPERANDO MANO",
      "feedbackTracking": "SIGUIENDO TU ÍNDICE",
      "feedbackAiming": "ACÉRCATE A UN OBJETIVO",
      "feedbackLocked": "OBJETIVO FIJADO · HAZ PINZA",
      "feedbackConfirming": "CONFIRMANDO SELECCIÓN",
      "feedbackDone": "ACCIÓN EJECUTADA",
    ...
    "success": {
      ...
      "tech": "Soluciones digitales listas para presentar con demos, reportes y automatizaciones.",
      "arch": "Ambientes, recorridos y evidencias visuales para que el cliente imagine su proyecto.",
      "techCards": [
        [
          "Sistema Redes Sociales",
          "Monitoreo, evidencias y reportes digitales."
        ],
        [
          "Poder Judicial Masivo",
          "Consultas automatizadas y exportación ordenada."
        ],
        [
          "SUNAT / DNI Masivo",
          "Validaciones por lote con reportes ejecutivos."
        ]
      ],
      "archCards": [
        [
          "Barbería Premium",
          "Diseño comercial con estaciones, iluminación y flujo de atención."
        ],
        [
          "Spa & Belleza",
          "Ambientes cálidos, relajantes y fotogénicos."
        ],
        [
          "Departamento",
          "Recorridos de primer y segundo piso con videos."
        ]
      ]
    },
    "process": {
      ...
      "steps": [
        [
          "Diagnóstico",
          "Entendemos la necesidad, alcance y objetivos."
        ],
        [
          "Propuesta",
          "Diseñamos una solución visual, técnica y comercial."
        ],
        [
          "Ejecución",
          "Construimos, automatizamos o implementamos con control."
        ],
        [
          "Entrega",
    ...
    "ai": {
      ...
      "title": "Flujos inteligentes para empresas modernas",
      "cards": [
        "Bots de consulta masiva",
        "Dashboards ejecutivos",
    ...
    "contact": {
      ...
      "whatsappIntro": "Hola JYM, quiero cotizar un proyecto.",
      "portalOptions": [
    ...
    "labels": {
      ...
      "segundoPiso": "Segundo piso",
      "follow": "SÍGUENOS",
      "video": "Video"
    },
    "guide": {
      "techName": "JYM Bot",
      "techMessage": "Te acompaño por nuestras automatizaciones y sistemas.",
      "archName": "Guía de diseño",
      "archMessage": "Te acompaño por proyectos, espacios y obras."
    },
    "smart": {
      "portal": {
        "kicker": "Dos especialidades",
        "title": "Una empresa preparada para transformar negocios y espacios",
        "cards": [
          "Tecnología empresarial",
          "Arquitectura y diseño",
          "Automatización de procesos",
      ...
      "arch": {
        "kicker": "Arquitectura + Diseño",
        "title": "Soluciones integrales para diseño y obra",
        "cards": [
          "Diseño residencial",
          "Diseño comercial y corporativo",
          "Ejecución de obras",
    ...
    "companion": {
      ...
      "greet": "¡Salúdame!",
      "hideAlien": "Ocultar visitante",
      "returnAlien": "Mostrar nuevamente al marcianito",
  ...
  "en": {
    ...
    "hero": {
      ...
      "techBadge": "Digital solutions",
      "archBadge": "Design and architecture",
    ...
    "archCatalog": {
      "barberia": [
        "Barbershop",
        "Commercial design",
        "Station design, lighting, mirrors, reception and visual journey for premium service."
      ],
      "estilismo": [
        "Styling",
        "Professional beauty",
        "Elegant salon spaces for customer service, brand identity and comfortable circulation."
      ],
      "lash": [
        "Lash",
        "Visual studio",
        "Clean and photogenic spaces for lashes, brows and specialized beauty services."
      ],
      "manicure": [
        "Manicure / Pedicure",
        "Detail and comfort",
        "Comfortable, organized and visually attractive service area for nails and pedicure."
      ],
      "spa": [
        "Spa",
        "Wellness",
        "Warm and relaxing sensory atmospheres for massage, rest and premium experience."
      ],
      "terraza": [
        "Terrace",
        "Premium outdoor",
        "Outdoor spaces with lighting, circulation, style and meeting areas."
      ],
      "departamento": [
        "Apartment",
        "3D tours",
        "First and second floor videos to show layout, finishes and walkthrough experience."
      ],
      "ejecucion": [
        "Construction",
        "Completed work",
        "Real evidence of construction, finishes and implementation of kitchens, bedrooms and living rooms."
      ]
    },
    "techCatalog": {
      "redes": [
    ...
    "archGesture": {
      ...
      "scrollDown": "Scrolling down the page",
      "scrollUp": "Scrolling up the page",
      "scrollDownGesture": "SCROLL DOWN",
      "scrollUpGesture": "SCROLL UP",
      "scrollUpShort": "UP",
    ...
    "gestureExperience": {
      ...
      "bootSensor": "INITIALIZING SENSOR",
      "bootModel": "LOADING HAND MODEL",
      "bootTracking": "LOOKING FOR YOUR HAND",
      "bootReady": "TRACKING READY",
      "globalUnlock": "GESTURE CONTROL UNLOCKED",
      ...
      "tutorialTitle": "LEARN IN 3 STEPS",
      "tutorialSteps": ["Show your hand", "Point at a card", "Pinch to select"],
      "tutorialHand": "STEP 1 · Show me one hand",
      "tutorialAim": "STEP 2 · Now point at a card",
      "tutorialPinch": "TARGET LOCKED · Pinch now",
      "tutorialComplete": "Perfect · you can now control JYM",
      "tutorialReady": "Ready. You can now enable control across the website.",
      "globalEnable": "Control JYM",
      "globalActive": "GESTURE MODE ACTIVE",
      "globalHelp": "Index: point · Pinch: select · Open hand: navigate · Fist: cancel",
      "globalExit": "Exit",
      "globalEnabledToast": "Global mode enabled · control JYM with your hand",
      "globalAimToast": "Point at a highlighted control before pinching",
      ...
      "selectionConfirmed": "ACTION CONFIRMED",
      "feedbackIdle": "WAITING FOR HAND",
      "feedbackTracking": "FOLLOWING YOUR INDEX",
      "feedbackAiming": "MOVE CLOSER TO A TARGET",
      "feedbackLocked": "TARGET LOCKED · PINCH NOW",
      "feedbackConfirming": "CONFIRMING SELECTION",
      "feedbackDone": "ACTION EXECUTED",
    ...
    "success": {
      ...
      "tech": "Digital solutions ready to present with demos, reports and automation.",
      "arch": "Spaces, tours and visual evidence so clients can imagine their project.",
      "techCards": [
        [
          "Social Media System",
          "Monitoring, evidence and digital reports."
        ],
        [
          "Mass Judicial Search",
          "Automated queries and organized export."
        ],
        [
          "SUNAT / ID Batch",
          "Batch validations with executive reports."
        ]
      ],
      "archCards": [
        [
          "Premium Barbershop",
          "Commercial design with stations, lighting and customer flow."
        ],
        [
          "Spa & Beauty",
          "Warm, relaxing and photogenic environments."
        ],
        [
          "Apartment",
          "First and second floor tours with videos."
        ]
      ]
    },
    "process": {
      ...
      "steps": [
        [
          "Discovery",
          "We understand the need, scope and goals."
        ],
        [
          "Proposal",
          "We design a visual, technical and commercial solution."
        ],
        [
          "Execution",
          "We build, automate or implement with control."
        ],
        [
          "Delivery",
    ...
    "ai": {
      ...
      "title": "Smart workflows for modern companies",
      "cards": [
        "Mass query bots",
        "Executive dashboards",
        "Automatic reports",
    ...
    "contact": {
      ...
      "whatsappIntro": "Hello JYM, I would like a project quote.",
      "portalOptions": [
    ...
    "guide": {
      "techName": "JYM Bot",
      "techMessage": "I will guide you through our automation and systems.",
      "archName": "Design guide",
      "archMessage": "I will guide you through projects, spaces and construction."
    },
    "smart": {
      "portal": {
        "kicker": "Two specialties",
        "title": "One company ready to transform businesses and spaces",
        "cards": [
          "Business technology",
          "Architecture and design",
          "Process automation",
      ...
      "arch": {
        ...
        "title": "Comprehensive design and construction solutions",
        "cards": [
          "Residential design",
          "Commercial and corporate design",
          "Construction execution",
    ...
    "companion": {
      ...
      "greet": "Say hello!",
      "hideAlien": "Hide visitor",
      "returnAlien": "Show the alien again",
